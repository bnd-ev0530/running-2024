...
function blueTheme() {
  ...
  document.documentElement.style.setProperty(
    "--Footer",
    "url(images/footer-bg.gif)"
  );
  document.documentElement.style.setProperty(
    "--CharSelect",
    "url(images/charselect.png)"
  );
  document.documentElement.style.setProperty("--CharColor", "#0080d0");
  document
    .querySelector('meta[name="theme-color"]')
    .setAttribute("content", "#257BE6");
  ...
  // document.getElementById("SEGA").src =
  //   "https://www.sonicthehedgehog.com/wp-content/uploads/2021/08/Sega_Logo-WHT-R.png.webp";
