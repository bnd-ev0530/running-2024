...
var musicList = [
  ...
  "audios/Chun-nan (Night) - Sonic Unleashed [OST].mp3",
  "audios/Options Screen - Sonic R [OST].mp3",
...
var gameMusicList = [
  "audios/Green Hill (Modern) - Sonic Generations [OST].mp3",
  "audios/Live and Learn by Crush 40 (Main Theme of SA2).mp3",
  "audios/Escape From the City (City Escape) - Sonic Adventure 2 [OST].mp3",
  "audios/BOSS BATTLE BIG ARM.mp3",
  "audios/Crisis City - Sonic the Hedgehog [OST].mp3",
  "audios/Kick The Rock! (feat. Hunnid-P) - Wild Canyon Theme from Sonic Adventure 2.mp3",
  "audios/Undefeatable (feat. Kellin Quinn).mp3",
  "audios/Dragon Road (Day) - Sonic Unleashed [OST].mp3",
  "audios/Doomsday Zone - Sonic & Knuckles [OST].mp3",
  "audios/Vela-Nova - Sonic Rush [OST].mp3",
...
var gameoverMusicList = [
  ...
  "audios/Sonic 1 Music Game Over.mp3",
  "audios/Sonic 3 And Knuckles OST - Game Over.mp3",
...
// 게임 로딩 음악
var Game = new Audio("audios/bnd_trailer.mp3");
Game.volume = 0.5;
...
var Return = new Audio(
  "audios/Sonic Mega Collection - Game Unlocked (Sound Effect).mp3"
);
Return.volume = 1;
...
var ScoreHit = new Audio(
  "audios/Sonic the Hedgehog Cha Ching Sound Effect.mp3"
);
ScoreHit.volume = 0.8;
...
/* 🦔🦔🦔🦔Logos🦔🦔🦔🦔 */
var SonicR = new Audio(
  "audios/Sonic Feeling Good (Jason Griffith) sound effect (1080p 60fps).mp3"
);
SonicR.volume = 1;
