...
window.addEventListener("DOMContentLoaded", function (event) {
  ...
  var imageUrls = [
    ...
    "sprites/badnik2.gif",
    "sprites/ground.png",
    "sprites/background.gif",
    "images/sonic.ico",
    "images/Sonic_Runners_logo.png",
    "sprites/score.png",
    "images/footer-bg.gif",
    "images/header.png",
    "sprites/0.png",
    "sprites/1.png",
    "sprites/2.png",
    "sprites/3.png",
    "images/sega-dark.png",
    "images/footer-bg-dark.gif",
    "images/header-dark.jpg",
    "sprites/gameover.png",
    "sprites/gameover-sonic.gif",
    "images/charselect.png",
    "images/charselect-dark.png",
    "images/select-a-character.png",
    // "images/coming.png",
  ...
  if (storedGameIndex !== null) {
    ...
    // 게임 로딩 음악
    Game = new Audio("audios/bnd_trailer.mp3");
    Game.volume = 0.5;
  }
